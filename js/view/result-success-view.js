...
import {SECONDS_IN_MINUTES, formatWords, getStatResults, Dictionary, getUserScore} from '../utils';
...
export default class ResultSuccessView extends AbstractView {
  constructor(state, data) {
    ...
    this.fastAnswers = this.state.userAnswersInfo.filter((it) => it.time < 30);
