...
const resultSuccessScreenElement = getElementFromTemplate(`
  ...
  `);
const returnButtonResultSuccessElement = resultSuccessScreenElement.querySelector(`.result__replay`);

returnButtonResultSuccessElement.addEventListener(`click`, onBackButtonClick);
